...
// Files to copy
const filesToCopy = ['index.html', 'ciccada_injection.js', 'cybersecurity.html', 'contact.html', 'WhatsApp Video 2026-08-31 at 16.10.49.mp4'];
filesToCopy.forEach(file => {
  ...
  if (fs.existsSync(src)) {
    if (file === 'index.html') {
      ...
      html = html.replace(/Noda Patel/g, 'Sameer Chavan');
      html = html.replace(/AI Consultant &amp; Builder/g, 'AI Machine Learning Engineer');
      html = html.replace(/AI Consultant & Builder/g, 'AI Machine Learning Engineer');
      html = html.replace(/Founder &amp; Security Engineer/g, 'AI Machine Learning Engineer');
      html = html.replace(/Founder & Security Engineer/g, 'AI Machine Learning Engineer');
      html = html.replace(/8 yrs/g, 'Young Founder');
      html = html.replace(/Shipping production AI and automation systems/g, 'Building scalable AI and Machine Learning systems');
      html = html.replace(/shipping production AI & automation/g, 'Building scalable AI & Machine Learning systems');
      html = html.replace(/I've spent the last decade shipping AI inside startups and agencies — long before LLMs were a buzzword\. I work directly with founders, no junior team, no SOW theatre\./g, 'As an AI & Machine Learning Engineer, I design and deploy intelligent models, automated pipelines, and mission-critical systems.');
